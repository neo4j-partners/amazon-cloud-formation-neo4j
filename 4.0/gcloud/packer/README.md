...
out because of recent package naming, if you want v4.0.11, you need to install
`1:4.0.11`.
...
```
$ gcloud compute images describe neo4j-enterprise-1-4-0-11-apoc --project launcher-public
...
gcloud compute instances create my-neo4j-instance \
    --image neo4j-enterprise-1-4-0-11 \
    --tags neo4j \
