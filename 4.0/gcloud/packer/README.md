...
out because of recent package naming, if you want v4.0.10, you need to install
`1:4.0.10`.
...
```
$ gcloud compute images describe neo4j-enterprise-1-4-0-10-apoc --project launcher-public
...
gcloud compute instances create my-neo4j-instance \
    --image neo4j-enterprise-1-4-0-10 \
    --tags neo4j \
