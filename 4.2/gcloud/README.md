...
<<<<<<< HEAD:4.1/gcloud/README.md
There should be a subdirectory for every deployed version (i.e. 4.2.1) and the jinja templates are copied to this location like so:
