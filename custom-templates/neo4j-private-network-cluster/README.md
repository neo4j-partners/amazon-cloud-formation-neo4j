...
3) Change to the directory ```amazon-cloud-formation-neo4j/custom-templates/neo4j-private-network-cluster``` and edit the file ```deploy.sh``` and update the variables contained therein:
