...
add_cypher_ip_blocklist
start_neo4j
# Switch python3 default to 3.11 only after all aws-cli calls are complete.
# awscli2 RPM installs its modules under python3.9 site-packages; switching
# the alternative earlier breaks /usr/bin/aws (shebang: #!/usr/bin/python3).
