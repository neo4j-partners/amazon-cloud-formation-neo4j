...
def _run_ssm_shell(
    ...
    """Run a shell command on an instance via SSM and return (status, stdout, stderr).

    Polls until the invocation reaches a terminal state. Raises on transport
    error or if the invocation does not finish within timeout_seconds.
    """
